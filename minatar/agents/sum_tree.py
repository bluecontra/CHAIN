# This file is originally from https://github.com/google/dopamine/blob/master/dopamine/replay_memory/sum_tree.py
#
# coding=utf-8
...
class SumTree(object):
    ...
    def set_from_batch(self, node_indices, values):
      return