...
from configs.deepac_chain_auto_configs import Args
...
if __name__ == "__main__":
    ...
    args = tyro.cli(Args)
    run_name = f"{args.alg}_{args.env_id}_trls{args.target_rel_loss_scale}"
    ...
    # Initialize agent
    if args.alg == "td3_pcr_auto":
        from algs.td3_pcr_auto import TD3_PCR_Auto
        ...
        kwargs["target_rel_loss_scale"] = args.target_rel_loss_scale
        agent = TD3_PCR_Auto(**kwargs)
