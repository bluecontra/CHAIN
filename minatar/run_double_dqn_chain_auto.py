...
def get_args_from_parser():
    ...
    parser.add_argument("--alg", type=str, default='ddqn_chain_auto', help='env')
...
def run_exp(args):
    ...
    run_name = f"{args.env}_{args.alg}" \
               f"_i{args.reg_his_idx}t{args.target_rel_loss_scale}"
    ...
    # Init RL agent
    if args.alg == 'ddqn_chain_auto':
        from agents.double_dqn_chain_auto import DoubleDQN_CHAINAuto
        agent = DoubleDQN_CHAINAuto(state_shape=state_shape, num_actions=num_actions, device=device,
                                    ...
                                    target_rel_loss_scale=args.target_rel_loss_scale, reg_his_idx=args.reg_his_idx, )
    else:
